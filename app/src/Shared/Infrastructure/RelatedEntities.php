...
final class RelatedEntities
{
    ...
    {
        return $this->bodyTypesByCriteriaSearcher->__invoke(
    ...
    {
        return $this->vehicleMakersNameByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
    ...
    {
        return $this->modelsOfVehicleByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
    ...
    {
        return $this->districtsByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
    ...
    {
        return $this->reasonsForTripByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
    ...
    {
        return $this->trafficPoliceBoothsByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
    ...
    {
        return $this->identityCardTypesByCriteriaSearcher->__invoke(
            self::DISPLAY_ALL_ITEMS,
            self::SORT_A_LIST_BY_DESCRIPTION,
            self::SORT_A_LIST_ALPHABETICALLY,
            self::LIST_END_ON_1000,
