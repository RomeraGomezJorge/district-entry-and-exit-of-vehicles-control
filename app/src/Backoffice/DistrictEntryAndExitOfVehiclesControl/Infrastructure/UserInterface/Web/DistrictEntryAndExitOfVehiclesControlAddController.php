    ...
    ): Response
    {
        return $this->render(
            ...
            [
                ...
                'vehicle_body_type_id'    => $this->settingDefaultIfVehicleBodyTypeIdIsEmpty(
                    $relatedEntities,
                    $flashSession
                ),
                'vehicle_maker_name_id'   => $flashSession->get('inputs.vehicle_maker_name_id'), 'model_of_vehicle_id' => $flashSession->get('inputs.model_of_vehicle_id'),
                'trip_origin_id'          => $flashSession->get('inputs.trip_origin_id'),
                'trip_destination_id'     => $flashSession->get('inputs.trip_destination_id'),
                'reason_for_trip_id'      => $flashSession->get('inputs.reason_for_trip_id'),
