<?php
	...
	use App\Backoffice\IdentityCardType\Application\Counter\IdentityCardTypeCounter;
	...
	class IdentityCardTypeGetController extends WebController
	{
		public function __invoke(
			Request $request,
			IdentityCardTypesByCriteriaSearcher $itemsByCriteriaSearcher,
			...
			$identityCardTypes = $itemsByCriteriaSearcher->__invoke($filters, $order, $orderBy, $limit,
			...
			return $this->render(TwigTemplateConstants::LIST_FILE_PATH, [
				...
				'totalItem' => $totalItem,
				'identity_card_types' => $identityCardTypes
			]);
		}
	}
