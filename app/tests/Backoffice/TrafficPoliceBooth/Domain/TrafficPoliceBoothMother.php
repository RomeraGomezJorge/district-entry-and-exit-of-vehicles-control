...
final class TrafficPoliceBoothMother extends testCase
{
    ...
    {
	    $uniqueTrafficPoliceBoothDescriptionSpecificationStub  = (new TrafficPoliceBoothMother)->uniqueTrafficPoliceBoothDescriptionSpecificationStub();
    ...
    public function uniqueTrafficPoliceBoothDescriptionSpecificationStub()
    {
