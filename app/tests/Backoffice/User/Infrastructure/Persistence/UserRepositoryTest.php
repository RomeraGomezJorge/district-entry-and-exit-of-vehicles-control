<?php
	...
	final class UserRepositoryTest extends UserInfrastructureTestCase
	{
		...
		{
			$existingUser = UserMother::randomWithARoleAndTrafficPoliceBooth($this->roleFound,
		...
		{
			$dddInPhpUser = UserMother::randomWithRoleWithTrafficPoliceBoothAndUsername($this->roleFound,
				$this->trafficPoliceBoothFound, 'DDD en PHP');
			$dddInJavaUser = UserMother::randomWithRoleWithTrafficPoliceBoothAndUsername($this->roleFound,
				$this->trafficPoliceBoothFound, 'DDD en Java');
			$intellijUser = UserMother::randomWithRoleWithTrafficPoliceBoothAndUsername($this->roleFound,
				$this->trafficPoliceBoothFound, 'Exprimiendo Intellij');
