...
final class TrafficPoliceBoothUpdateTest extends TrafficPoliceBoothModuleUnitTestCase
{
	...
	protected function setUp(): void
	{
		...
		$this->updater = new TrafficPoliceBoothUpdater($this->repository(),$this->uniqueTrafficPoliceBoothDescriptionSpecification());
